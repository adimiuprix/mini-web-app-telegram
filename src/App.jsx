      ...
      <div class="px-3 py-36">
          <div class="mx-auto max-w-screen-lg">
              <div class="text-center">
                  <a class="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 border-transparent bg-primary text-primary-foreground hover:bg-primary/80" href="#" target="_blank" rel="noopener">
                      <TwitterLogoIcon className="mr-1 size-5" /> Follow Adi Miuprix on twitter
                  </a>
              </div>

              <div class="mt-3 text-center text-4xl font-bold tracking-tight">
                  Selamat Datang Di <span class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">Mini Web App</span> Dengan Telegram.
              </div>
